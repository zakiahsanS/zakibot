...
const vcard1 = 'BEGIN:VCARD\n' // JAN DI GANTI
            + 'VERSION:3.0\n' // JAN DI GANTI
            + 'FN:nisa\n' // JAN DI GANTI TOD NTAR EROR
            + 'ORG:Co Owner lord Bot;\n' // GANTI AJA
            + 'TEL;type=CELL;type=VOICE;waid=+62852834278600:+62 852-83427-8600\n' // JAN DI GANTI TOD
            + 'END:VCARD' // JAN DI GANTI

prefix = "#" // PREFIX BOT GANTI AJA
name = "LORD BOT" // NAMA BOT GANTI AJA
rdaftar = "@sanglord" // JAN DI GANTI TOD
rmenu = "@sanglord" // JAN DI GANTI TOD
botinfo = "@sanglord" // JAN DI GANTI TOD
...
*║KALO GAK MAU DONASI*
*║FOLLOW IG GUA https://instagram.com/sanglord_*
*║SUBS YT GUA https://youtube.com/c/MikazuMZ*
*║KALO UDAH SS BUKTI KIRIM KE https://wa.me/6283144780782*
  ╙───々
  ╓───「 *TQTO* 」
*║MhankBar²*
*║Farhan (Fxc7)*
...
lord.sendMessage(from, dmenu, text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "Punya lord", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('lord.jpg')}}}})
lord.sendMessage(from, brando, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true}) 	    
            break
            case 'help':
brando = await getBuffer(`https://pencarikode.xyz/api/cita-cita?apikey=pais`, {method: 'get'})                
lord.sendMessage(from, help(name), text, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "@LORDBOT", 'jpegThumbnail': fs.readFileSync('./sticker/lord.webp')}}}})
lord.sendMessage(from, brando, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
    	    break
            case 'gifstiker':
				case 'stiker':
				...
				case 's':
						...
						await ffmpeg(`./${media}`)
							...
							.on('end', function () {
								...
								lord.sendMessage(from, buff, sticker, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "nih ajg", 'jpegThumbnail': fs.readFileSync('./sticker/lord.webp')}}}})
								fs.unlinkSync(media)
								fs.unlinkSync(ran)
							})
...
// last
				...
				if (isLimit(sender)) return reply(limitend(pushname2))
					...
					exec(`ffmpeg -i ${media} ${ran}`, (err) => {
						...
						lord.sendMessage(from, buffer, image, {quoted: mek, caption: 'jangan lupa donasi bang jan make doang'})
						fs.unlinkSync(ran)
					})
					await limitAdd(sender) 
					break 
         ...
         case 'lirik':
				...
				if (isLimit(sender)) return reply(limitend(pushname2))
					if (args.length < 1) return reply('Lu Afk Karna Apa Tod??')
                                        ...
                                        lord.sendMessage(from, fku, text, {quoted: mek})
				const afk = fs.readFileSync('./lordganz/afk');
                lord.sendMessage(from, afk, MessageType.image, {quoted: mek, caption: '*KAKA INI  SEDANG AFK  JANGAN DI GANGGU YA!!*'})
                 break 
                                       break
				case 'unafk':
                                        tels = body.slice(4)
...
quoted: mek, caption: `Hasil Dari *${daerah}*`
  ...
  break
			    ...
			    if (!isUser) return reply(mess.only.userB)
					...
					mentions(`╔═══✪ Tag By *${pushname2}* ✪══`+ teks +'╚═══〘 *lord BOT* 〙═══', members_id, true)
					break
			    case 'mentionall':
			    if (isBanned) return reply(mess.only.benned)    
			    if (!isUser) return reply(mess.only.userB)
					...
					mentions(`╔══〘  *${body.slice(12)}*  〙✪══`+teks+'╚═〘 *lord BOT* 〙', members_id, true)
					break
			    case 'kbbi':
			    if (isBanned) return reply(mess.only.benned)    
			    if (!isUser) return reply(mess.only.userB)
...
case 'husbu':
        ...
        if (budy.includes("lorda")){  // JAN DI UBAH TOD
