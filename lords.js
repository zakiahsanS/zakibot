...
lord.sendMessage(from, dmenu, text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "Punya Zaki", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('lord.jpg')}}}})
          ...
          contextInfo: { mentionedJid: [from] }
           ...
           lord.sendMessage(from, options, text, { quoted: mek } )
				...
				if (isLimit(sender)) return reply(limitend(pushname2))
					...
					lord.sendMessage(from, crot, image, { quoted: iky, caption: '*Quotes Kehidupan*\n\n'+ quo })
					await limitAdd(sender)
					break
		case 'quotesislami':
					 // Update By Zaki				
				...
				if (isLimit(sender)) return reply(limitend(pushname2))
					...
					lord.sendMessage(from, islam, image, { quoted: iky, caption: '*Quotes Islami*\n\n'+ isl })
					await limitAdd(sender)
					break	
		case 'quotesnasehat':
					 // Update By Zaki				
				...
				if (isLimit(sender)) return reply(limitend(pushname2))
					...
					lord.sendMessage(from, nase, image, { quoted: iky, caption: '*Quotes Nasehat*\n\n'+ nsh })
					await limitAdd(sender)
					break	
		case 'quotescinta':
					 // Update By Zaki				
				...
				if (isLimit(sender)) return reply(limitend(pushname2))
					...
					lord.sendMessage(from, cta, image, { quoted: iky, caption: '*Quotes Cinta*\n\n'+ cin })
					await limitAdd(sender)
					break
		case 'quotesmotivasi':
					 // Update By Zaki				
				...
				if (isLimit(sender)) return reply(limitend(pushname2))
					...
					lord.sendMessage(from, vass, image, { quoted: iky, caption: '*Motivasi*\n\n'+ cin })
					await limitAdd(sender)
					break
                case 'speed':
                case 'ping':
         ...
         case 'lirik':
				...
				const afk = fs.readFileSync('./zakiganz/afk');
...
// akhir fitur anime
              ...
              case 'randomkpop':
                ...
                if (isLimit(sender)) return reply(limitend(pushname2))
					anu = await fetchJson(`https://api.shizukaa.xyz/api/randombts?apikey=zaki633`, {method: 'get'})
           ...
           case 'randomexo':
                ...
                if (isLimit(sender)) return reply(limitend(pushname2))
					anu = await fetchJson(`https://api.shizukaa.xyz/api/randomexo?apikey=zaki633`, {method: 'get'})
					buffer = await getBuffer(anu.result)
					zaki.sendMessage(from, buffer, image, {quoted: mek })
					await limitAdd(sender) 
					break
           case 'blackpink':
                ...
                if (isLimit(sender)) return reply(limitend(pushname2))
					anu = await fetchJson(`https://api.shizukaa.xyz/api/blackpink?apikey=zaki633`, {method: 'get'})
					buffer = await getBuffer(anu.result)
					zaki.sendMessage(from, buffer, image, {quoted: mek })
					await limitAdd(sender) 
					break
           case 'imageislamic':
                ...
                if (isLimit(sender)) return reply(limitend(pushname2))
					anu = await fetchJson(`https://api.shizukaa.xyz/api/wpislamic?apikey=zaki633`, {method: 'get'})
					buffer = await getBuffer(anu.result)
					zaki.sendMessage(from, buffer, image, {quoted: mek })
					await limitAdd(sender) 
					break
           case 'imagecyberspace':
                ...
                if (isLimit(sender)) return reply(limitend(pushname2))
					anu = await fetchJson(`https://api.shizukaa.xyz/api/wpcyberspace?apikey=zaki633`, {method: 'get'})
					buffer = await getBuffer(anu.result)
					zaki.sendMessage(from, buffer, image, {quoted: mek })
					await limitAdd(sender) 
					break
           case 'imagegame':
                ...
                if (isLimit(sender)) return reply(limitend(pushname2))
					anu = await fetchJson(`https://api.shizukaa.xyz/api/wpgame?apikey=zaki633`, {method: 'get'})
					buffer = await getBuffer(anu.result)
...
//creator
				...
				if (isLimit(sender)) return reply(limitend(pushname2))
			if (args.length < 1) return reply(`${name} Contoh zaki|15|zakiganteng`)
			reply(mess.wait)
					tulis = body.slice(7)
				  nama = tulis.split("/")[0];
					kelas = tulis.split("/")[1];
					...
					if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
					if (args.length < 1) return reply(`${name} Contoh Zaki|15|ZakiGantengFixNoDebat`)
				ct = body.slice(8)
				reply(mess.wait())
...
group = await lord.groupMetadata(from);
...
await lord.sendMessage(from, options, text)
break
...
case 'playmp3': // masih ngebug:)
                ...
                break
                case 'playv': // Case By Zaki
                if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
				if (args.length < 1) return reply(`Yang mau dicari apaan? Titit kah?`)
                limit.addLimit(sender.id, _limit, isPremium, isOwner)
                await lord.reply(from, ind.wait() ,id)
                const getvid = await axios.get(`https://api.zeks.xyz/api/ytplaymp4/2?apikey=apivinz&q=${q}`)
                    ...
                    await lord.reply(from, 'Maaf durasi musik sudah melebihi batas maksimal 10 MB!', id)
                } else {
                    await lord.sendFileFromUrl(from, getvid.data.result.thumb, 'thumb.jpg', `Title: ${getvid.data.result.title}\n\n───────────⚪───────────\n(っ◔◡◔)っ\n───────────⚪───────────\n➥Size: ${getvid.data.result.size}\n➥Type: Mp4\n➥Link Download: ${getvid.data.result.link}\n\n*Mohon Tunggu Bot Akan Mengirim Video!*`, id)
                    await lord.sendFileFromUrl(from, getvid.data.result.link, 'play.mp4' , '', id)
                }
            break
                case 'ytmp3':
  if (isBanned) return reply(mess.only.benned)    
...
case 'husbu':
        ...
        if (budy.includes("ZAKI")){  // JAN DI UBAH TOD
        reply(`*${pushname2}*, ɴɢᴀᴘᴀɪɴ ᴍᴀɴɢɢɪʟ² ᴏᴡɴᴇʀ ɢᴡ?`)
        const d = fs.readFileSync('./sticker/anjim.webp');
        lord.sendMessage(from, d, sticker, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "stop manggil ownerku", 'jpegThumbnail': fs.readFileSync('./sticker/lord.webp')}}}})
        }
